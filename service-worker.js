...
//
// If you go that route, make sure that whenever you update your sw-quote dependency, you reconcile any
...
var originalUrl = 'https://talaikis.com/api/quotes/random';
var index=0;
...
toolbox.router.get(/https:\/\/talaikis.com\/api\/quotes/, toolbox.networkFirst, {"cache":{"name":"scotchPWA-v7"}});
